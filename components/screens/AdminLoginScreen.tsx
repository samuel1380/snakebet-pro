...
export const AdminLoginScreen: React.FC<AdminLoginScreenProps> = ({ onAdminLogin, onBack }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 relative overflow-x-hidden bg-black">
      ...
      <div className="absolute top-0 -left-4 w-72 h-72 bg-emerald-900 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
      ...
      <div className="w-full max-w-md glass-panel p-1 rounded-3xl relative z-10 shadow-2xl animate-in fade-in zoom-in duration-500">
        <div className="bg-gray-900/90 rounded-[22px] p-8 backdrop-blur-xl border border-emerald-900/30">
          <div className="flex flex-col items-center mb-6">
            <div className="relative mb-4">
              <div className="absolute inset-0 bg-emerald-600 blur-xl opacity-20 rounded-full animate-pulse-fast"></div>
              <div className="relative p-4 bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-emerald-500/30 shadow-inner">
          ...
          <form onSubmit={handleAdminSubmit} className="space-y-4">
            ...
            <Button
              ...
              fullWidth
              disabled={loading}
              className="mt-4 py-3 group relative overflow-hidden bg-emerald-700 hover:bg-emerald-800 border-emerald-900 text-white"
            >
              {loading ? (
